...
CREATE TABLE changes_ranked (
    -- "LIKE changes INCLUDING ALL" not supported by sqlc (https://github.com/kyleconroy/sqlc/issues/481)
    -- Therefore copying the changes schema here.
